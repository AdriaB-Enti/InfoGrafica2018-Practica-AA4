...
int main(int argc, char** argv) {
	...
	mainwindow = SDL_CreateWindow("Practica AA4", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
		1000, 900, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
